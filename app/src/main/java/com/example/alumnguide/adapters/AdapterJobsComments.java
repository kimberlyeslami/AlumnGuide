...
public class AdapterJobsComments extends RecyclerView.Adapter<AdapterJobsComments.MyHolder> {
    Context context;
    List<ModelJobsComment> commentList;
    String myUid,postId;


    public AdapterJobsComments(Context context, List<ModelJobsComment> commentList, String myUid, String postId) {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.row_job_comments,viewGroup, false);
