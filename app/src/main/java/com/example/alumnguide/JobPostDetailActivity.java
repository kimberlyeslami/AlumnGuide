...
import com.example.alumnguide.adapters.AdapterJobsComments;
import com.example.alumnguide.models.ModelJobsComment;
...
public class JobPostDetailActivity extends AppCompatActivity {
    ...
    List<ModelJobsComment> commentList;
    AdapterJobsComments adapterComments;
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds : dataSnapshot.getChildren()){
                    ModelJobsComment modelJobsComment = ds.getValue(ModelJobsComment.class);

                    commentList.add(modelJobsComment);
                    //pass myuid and postid as a parameter of comment adapter

                    //setup adapter
                    adapterComments = new AdapterJobsComments(getApplicationContext(),commentList,myUid,postId);
                    //set adapter
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (id == 0) {
                    ...
                    //edit is clicked
                    Intent intent = new Intent(JobPostDetailActivity.this, AddJobPostActivity.class);
    ...
    private void deleteWithImage() {
        ...
        picRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                Query fquery = FirebaseDatabase.getInstance().getReference("JobPosts").orderByChild("pId").equalTo(postId);
                fquery.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        Toast.makeText(JobPostDetailActivity.this, "Deleted successfully", Toast.LENGTH_SHORT).show();
                        pd.dismiss();
                    }
            ...
            public void onFailure(@NonNull Exception e) {
                pd.dismiss();
                Toast.makeText(JobPostDetailActivity.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void likePost() {
        ...
        final DatabaseReference likesRef = FirebaseDatabase.getInstance().getReference().child("Likes");
        final DatabaseReference postsRef = FirebaseDatabase.getInstance().getReference().child("JobPosts");
        likesRef.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (mProcessLike) {
        ...
        ref.child(timeStamp).setValue(hashMap)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        //added
                        pd.dismiss();
                        Toast.makeText(JobPostDetailActivity.this, "Comment Added..", Toast.LENGTH_SHORT).show();
                        commentEt.setText("");
                        updateCommentCount();
                    }
                }).addOnFailureListener(new OnFailureListener() {
