...
public class AddJobPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_jobs_post);

        actionBar = getSupportActionBar();
        actionBar.setTitle("Add New Jobs Post");
        //enable back btn
        ...
        uploadBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(title)) {
                    Toast.makeText(AddJobPostActivity.this, "Enter Title..", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (TextUtils.isEmpty(description)) {
                    Toast.makeText(AddJobPostActivity.this, "Enter Description..", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (isUpdateKey.equals("editPost")) {
    ...
    private void updateWithoutImage(String title, String description, String editPostId) {
        ...
        ref.child(editPostId).updateChildren(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                pd.dismiss();
                Toast.makeText(AddJobPostActivity.this, "Updated Post", Toast.LENGTH_SHORT).show();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                pd.dismiss();
                Toast.makeText(AddJobPostActivity.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void updateWithNowImage(final String title, final String description, final String editPostId) {
        ...
        String filePathAndName = "jobPosts/" + "JobPost_"+timeStamp;
    ...
    private void loadPostData(String editPostId) {
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("JobPosts");
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    if (uriTask.isSuccessful()) {
                        ...
                        ref.child(timeStamp).setValue(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                pd.dismiss();
                                Toast.makeText(AddJobPostActivity.this, "Post Published", Toast.LENGTH_SHORT).show();
                                titleEt.setText("");
