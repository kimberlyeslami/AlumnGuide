...
import com.example.alumnguide.adapters.HelpBotAdapter;
...
public class HelpBot extends AppCompatActivity {
  ...
  private HelpBotAdapter mAdapter;
  ...
  private static String TAG = "HelpBot";
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.fragment_aibot);
    ...
    mAdapter = new HelpBotAdapter(messageArrayList);
    ...
    private void recordMessage() {
        if (listening != true) {
            ...
            listening = true;
            Toast.makeText(HelpBot.this, "Listening....Click to Stop", Toast.LENGTH_LONG).show();

        } else {
            try {
                microphoneHelper.closeInputStream();
                listening = false;
                Toast.makeText(HelpBot.this, "Stopped Listening....Click to Start", Toast.LENGTH_LONG).show();
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    private void showError(final Exception e) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(HelpBot.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                e.printStackTrace();
            }
        });
    }
